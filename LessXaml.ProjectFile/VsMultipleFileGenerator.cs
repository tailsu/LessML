...
namespace LessXaml.ProjectFile
{
    public abstract class VsMultipleFileGenerator<IterativeElementType> : IEnumerable<IterativeElementType>, IVsSingleFileGenerator, IObjectWithSite
    {
        ...
        protected abstract string GetFileName(IterativeElementType element, out bool overwrite);
        ...
        public int Generate(string wszInputFilePath, string bstrInputFileContents, string wszDefaultNamespace, IntPtr[] rgbOutputFileContents, out uint pcbOutput, IVsGeneratorProgress pGenerateProgress)
        {
            ...
            foreach (IterativeElementType element in this)
            {
                try
                {
                    ...
                    bool overwrite;
                    string fileName = GetFileName(element, out overwrite);
                    ...
                    // create the file
                    if (overwrite || !File.Exists(strFile))
                    {
